...
def get_features(sample_size=5000,color_space='HSV', spatial_size=(16, 16), 
                 hist_bins=16, orient=9, pix_per_cell=8, 
                 cell_per_block=2, hog_channel=0, spatial_feat=True, 
                 hist_feat=True,hog_feat=True, load_saved=False):
    
    if load_saved:
        print('Loading saved features...')
        car_features, notcar_features = pickle.load( open( "features.p", "rb" ) )
        
    else: 
        print("Extracting features from %s samples..." % sample_size)          
        ...
        pickle.dump( (car_features, notcar_features), open( "features.p", "wb" ) )
...
def slide_window(img, x_start_stop=[None, None], y_start_stop=[None, None], 
    ...
    """
    Returns a list of windows from x_start_stop to y_start_stop
    """
...
def get_scaled_X_y(car_features, notcar_features):
...
def get_classifier(scaled_X, y, load_saved=False):
...
def visualize_searchgrid_and_hot(img, windows, hot_windows):
    """
    Draws the search grid and the hot windows.
    """

    print('Hot Windows...', hot_windows)
    search_grid_img = draw_boxes(img, windows, color=(0, 0, 255), thick=6)                    
